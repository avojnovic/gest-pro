...
namespace GestPro
{
    public partial class Principal : System.Web.UI.Page
    {
        ...
        {
            //PROYECTOS
            if ((AdminSesion.Instancia.UsuarioLogueado.Cargo.Perfil == GestPro.BussinesObjects.BussinesObjects.Cargo.PerfilesEnum.ProyectManager) || (AdminSesion.Instancia.UsuarioLogueado.Cargo.Perfil == GestPro.BussinesObjects.BussinesObjects.Cargo.PerfilesEnum.TeamLeader))
            {
            ...
            if (AdminSesion.Instancia.UsuarioLogueado.Cargo.Perfil == GestPro.BussinesObjects.BussinesObjects.Cargo.PerfilesEnum.ProyectManager)
            {
                //RECURSOS
            ...
            if (AdminSesion.Instancia.UsuarioLogueado.Cargo.Perfil != GestPro.BussinesObjects.BussinesObjects.Cargo.PerfilesEnum.Developer)
            {
            ...
            //USUARIO LOGUEADO
            string userName = AdminSesion.Instancia.UsuarioLogueado.Nombre + " " + AdminSesion.Instancia.UsuarioLogueado.Apellido;
            userName = "Usuario Logueado: " + userName + " / " + AdminSesion.Instancia.UsuarioLogueado.Cargo.Nombre;
